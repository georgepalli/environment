" Vim syntax file
" Language: Perl, ignoring __DATA__
" Maintainer: Ian L.
"
...
syn match  perlComment    "^__DATA__$" contains=perlTodo
...
" __END__ clauses
if exists("perl_fold")
  syntax region perlDATA    start="^__\(END\)__$" skip="." end="." contains=perlPOD fold
else
  syntax region perlDATA    start="^__\(END\)__$" skip="." end="." contains=perlPOD
endif
